        ...
        >
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.card}>
                    {/* <Image
                        source={{ uri: `http://${Config.dirImg}${imag.split('/').pop()}` }}
                    ...
                    {imag === null ?
                        (
                            <>
                                <Image source={{ uri: `http://190.6.81.46/uploads/iconoI.png` }} style={styles.imagePlaceholder} resizeMode="contain" />
                            </>
                        ) : (
                            <>
                                <Image source={{ uri: `http://${Config.dirImg}${imag.split('/').pop()}` }} style={styles.imagePlaceholder} resizeMode="contain" />
                            </>
                        )
                    }
